...
void Search::modify(std::vector<char> &vec, std::vector<int> holdPos, std::string word, std::vector < char > &copyvec) {
    std::string newWord;
...
void Search::setup(){
    ...
    modify(Search::vec, Search::holdPos, Search::word, Search::copyvec);
}
